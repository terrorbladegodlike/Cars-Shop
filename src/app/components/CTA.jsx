          ...
          <div className='flex-1 xl:ml-24 text-center md:text-left mb-12 md:mb-0'>
            <div className='max-w-[520px] mx-auto order-2 xl:order-none'>
              ...
              <motion.p
                ...
                className='mb-10'
              >
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Iusto itaque fugit tempore, corporis voluptates magnam nobis amet ducimus temporibus consequatur.
              </motion.p>
              {/* BTN */}
              <motion.div
